...
// spring framework에서는 서비스 interface를 상속받는 후손 클래스를 작성하도록 정해 놓았음
// 후손 Impl 클래스를 서비스클래스로 등록처리함 
@Service("memberService")  // servlet-context.xml에 서비스 모델 클래스로 자동 등록되는 어노테이션임  
public class MemberServiceImpl implements MemberService {
	// dao와 연결 처리(의존성 주입함 : DI)
	@Autowired
	...
	@Override
	public int selectCheckedId(String userId) {
		return memberDao.selectCheckedId(userId);
	}
