...
public class Paging implements java.io.Serializable{
	...
	private int listCount;	 		// 총 목록(행) 갯수 (뷰 페이지에서 사용)
	private int limit; 				// 한 페이지에 출력할 갯수 (뷰 페이지에서 사용)
	private int currentPage; 		// 출력할 현재 페이지 (뷰 페이지에서 사용)
	...
	private String urlMapping;  // 페이지 숫자 클릭시 요청할 url 저장용 (여러 서비스에서 함께 사용하기 위함) (뷰 페이지에서 사용)
	...
	public void calculate() {
		// 총 페이지 수 계산 :
		// 목록의 총 갯수가 21개 인 경우, 한 페이지에 출력할 목록이 10개인 경우 총 페이지 수는 3페이지임
		// 목록 1개도 한 페이지 차지함 
		this.maxPage = (int)((double)listCount / limit + 0.9);
		
		// 뷰 페이지 출력에 사용할 페이지 그룹의 시작값 지정
		// 목록 하단에 페이지 그룹의 페이지 숫자 갯수를 10개씩 출력한다면,
