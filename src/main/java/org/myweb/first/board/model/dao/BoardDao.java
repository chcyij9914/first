...
public class BoardDao {
	...
	public int selectSearchWriterCount(String search) {
	...
	public ArrayList<Board> selectSearchTitle(Search search){
		List<Board> list = sqlSessionTemplate.selectOne("boardMapper.selectSearchTitle", search);
		return (ArrayList<Board>)list;
	}
	
	public ArrayList<Board> selectSearchWriter(Search search){
		List<Board> list = sqlSessionTemplate.selectOne("boardMapper.selectSearchWriter", search);
		return (ArrayList<Board>)list;
	}
