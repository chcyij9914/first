<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- page 지시자 태그 안에 import 속성만 따로 분리 작성할 수 있음 --%>
...
<%-- session에 저장된 ioginUser를 찾으려면, el 내장객체인 sessionScope.저장이름으로 표기해도 됨 
		sessionScope를 생략하면 loginUser를 찾는 순서가
			...
			<ul id="menubar">
				<%-- 
				 ...
				 --%>
				 	...
				 	<li><a href="${ pageContext.servletContext.contextPath }/moveAOP.do">AOP</a></li>
