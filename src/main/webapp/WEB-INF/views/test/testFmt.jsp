...
<%-- <%@ taglib prefix="fmt" url ="https://jakarta.ee/jsp/jstl/Fmt" %> --%> 
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
value 속성에는 반드시 java.util.Date 객체를 사용해야 함 (java.sql.Date 사용 가능 : sub class) <br>
...
<fmt:formatDate value="${ current }" type="both" /> <br> <%-- 시간과 날짜 둘 다 포매팅 --%>
<hr>
...
<h4>fmt:timeZone 태그 : 시간대 설정하는 태그, fmt:setTimeZone 사용해도 됨</h4>
...
천 단위 구분 기호 적용 : <fmt:formatNumber value="123456789" groupingUsed="true" /> <br>
실수값 소수점 아래 자릿수 지정 : pattern 속성 사용 (#, 0 으로 자릿수 지정) <br>
#을 사용한 경우 : <fmt:formatNumber value="1.234567" pattern="#.##" />
#을 사용한 경우 :<fmt:formatNumber value="1.2" pattern="#.##" />
0을 사용한 경우 :<fmt:formatNumber value="1.2" pattern="#.00" />
<hr>
